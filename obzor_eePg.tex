...
\begin{figure}[htbp]
    \begin{minipage}[t]{0.24\textwidth}
		...
		\end{tikzpicture}
        \label{diag:hvp}
        \caption{Ведущий адронный вклад в $a_\mu$.}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.24\textwidth}
        \centering
		...
		\end{tikzpicture}
        \label{diag:hvp_Pg}
        \caption{Ведущий адронный вклад в $a_\mu$ связанный с $e^+ e^- \to ( \pi^0, \, \eta ) \gamma$.}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.24\textwidth}
        \centering
		...
		\end{tikzpicture}
        \label{diag:lbl}
        \caption{Ведущий адронный вклад света на свете в $a_\mu$.}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.24\textwidth}
        \centering
...
Таким образом,
вклад изучаемыч процессов в лидирующий влад адронной поляризации вакуума можно представить диаграммой~\ref{diag:hvp_Pg}.
